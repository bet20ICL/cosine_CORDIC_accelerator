...
# VARIANT="cordic_unroll1_var"
# iverilog -g 2012 -s tb_cordic_rd_file -o bin/tb_cordic_rd_file tb/tb_cordic_rd_file.sv wl_21/cordic_unroll/${VARIANT}.v wl_21/cordic_unroll/cordic_op.v wl_21/helpers/*
