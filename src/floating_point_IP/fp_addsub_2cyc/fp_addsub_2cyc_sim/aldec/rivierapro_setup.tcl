...
# ACDS 18.1 625 win32 2023.03.14.20:50:31
# ----------------------------------------
...
# ----------------------------------------
# If fp_addsub_2cyc is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "fp_addsub_2cyc"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fp_addsub_2cyc.vo"
}
