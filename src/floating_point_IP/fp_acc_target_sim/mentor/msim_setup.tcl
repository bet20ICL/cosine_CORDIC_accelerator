...
# ----------------------------------------
# If fp_acc_target is one of several IP cores in your
...
# ----------------------------------------
# ACDS 18.1 625 win32 2023.03.17.22:11:21
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "fp_acc_target"
}
...
alias com {
  ...
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fp_acc_target.vhd"        
}
