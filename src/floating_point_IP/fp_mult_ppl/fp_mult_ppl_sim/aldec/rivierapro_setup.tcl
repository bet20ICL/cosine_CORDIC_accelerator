...
# ACDS 18.1 625 win32 2023.03.12.19:13:40
# ----------------------------------------
...
# ----------------------------------------
# If fp_mult_ppl is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "fp_mult_ppl"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fp_mult_ppl.vo"
}
